...
"""
struct Spike <: AbstractDatapoint{1}
    neuron::Int64
    timestamp::Float64
end
...
assignment_id :
    ...
    the `indices` in `EventList` struct.
...
"""
Prior distributions for the PPSeq model.
...
"""
mutable struct SeqPriors <: AbstractPriors
...
"""
mutable struct SeqGlobals <: AbstractGlobals
...
sampled_amplitude :
    ...
    Gibbs samples).
"""
mutable struct SeqEvent <: AbstractEvent{Spike}
    spike_count::Int64
...
const PPSeq = NeymanScottModel{1, Spike, SeqEvent, SeqGlobals, SeqPriors}
